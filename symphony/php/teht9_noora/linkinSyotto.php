...
<html lang="en">
  <head>
    ...
    <title>Linkin syöttö/lisäys</title>
  </head>
  <body>
    ...
    <form class="form-signin" action="linkinLisays.php" method="post">
        ...
        <input name="linkki" type="text" id="inputLinkki" class="form-control" placeholder="Linkki" required>
        
        <label for="inputOtsikko" class="sr-only">Otsikko</label>
        <input name="otsikko" type="text" id="inputOtsikko" class="form-control" placeholder="Otsikko" required>
        
        <label for="inputKuvaus" class="sr-only">Kuvaus</label>
        <input name="kuvaus" type="text" id="inputKuvaus" class="form-control" placeholder="Kuvaus" required>
        
        <label for="inputAvainsana" class="sr-only">Avainsana</label>
        <input name="avainsana" type="text" id="inputAvainsana" class="form-control" placeholder="Avainsana" required>
