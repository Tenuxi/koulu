...
Koodaa hurtPayerHealth-metodi, joka vähentää pelihahmon terveyttä (damageToGive).

Koodaa setMaxHealth, joka asettaa pelihahmon maksimiterveyden.

Koodaa addPlayerHealth-metodi, joka lisää pelihahmon terveyttä (healthAmmount). Koodaa metodiin seuraava tarkistus. Mitä tarkistus tekee?

* jos (nykyinen HP > maksimi HP) niin
