...
<!-- Poista ulos kommentoinnit diveistä joita haluat käyttää! -------------------->
    ...
    <!-- Header ------------------------------------------------------------------>
    <header>Popup ikkuna</header>



    <ul id="navi" class="nav justify-content-center">
            <li class="nav-item">
                <button class="nav-link" onclick="ponnahdusIkkuna();">testi nappi</button>
            </li>
    </ul>
