...
-->
    ...
    <div id="napit">
        <button type="button" class="btn btn-primary" onclick="nappiFunktio()">Testi nappi</button>
    </div>
    ...
    <div id="huomautus" class="alert alert-danger" role="alert">
        Popup aukeaa kun vierittää 200px alaspäin.
    </div>

    <!-- Popup -------------------------------------------------------------------------------->
    <div class="popup">
        <span class="popuptext" id="myPopup">Toimiiko</span>
    </div>

    <div class="popup" onscroll="rullaFunktio()">
        <span class="popuptext" id="rullaPopup">Toimiiko rullaus!??</span>
    </div>
